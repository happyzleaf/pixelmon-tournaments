...
public class TournamentsExecutor implements CommandExecutor
{
	public static CommandSpec getSpec()
	{
		...
		children.put(Arrays.asList("reload"), ReloadCommand.getSpec());
		...
		children.put(Arrays.asList("leave"), LeaveCommand.getSpec());
		...
		children.put(Arrays.asList("ignore"), IgnoreCommand.getSpec());
		children.put(Arrays.asList("battlerules"), BattleRulesCommand.getSpec());
